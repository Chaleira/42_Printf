...
#    Updated: 2022/11/30 00:22:40 by plopes-c         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRCS			=	ft_printf.c 			libft/ft_isprint.c		libft/ft_isalnum.c		libft/ft_memcmp.c		\
					...
					libft/ft_putnbr_unsigned_fd.c					libft/ft_putnbr_hexa_fd.c
